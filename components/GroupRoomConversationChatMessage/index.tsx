...
import { getConversationMessage, getGroupRoomConversationMessage, getGroupRoomMessage, getMessage } from '../../src/graphql/queries';
import MessageReply from '../MessageReply';
import { useActionSheet } from "@expo/react-native-action-sheet";
import EmojiSelector from "react-native-emoji-selector";
import * as Clipboard from 'expo-clipboard';

export type GroupRoomConversationChatMessageProps = {
    message: Message;
    myId: String;
    myName: String;
...
const GroupRoomConversationChatMessage = (props: GroupRoomConversationChatMessageProps) => {
        ...
        if (message?.replyToMessageID) {
            const fetchReplyToMessage = async () => {
                try {
                    ...
                    setRepliedTo(userData.data.getGroupRoomConversationMessage)
                } catch (e) {
                    console.log(e);
                }
            } 
...
export default GroupRoomConversationChatMessage;