...
import { getGroupRoomMessage, getMessage } from '../../src/graphql/queries';
...
const GroupChatMessage = (props: GroupChatMessageProps) => {
        ...
        if (message?.replyToMessageID) {
            const fetchReplyToMessage = async () => {
                try {
                    ...
                    setRepliedTo(userData.data.getGroupRoomMessage)
                } catch (e) {
                    console.log(e);
                }
            } 
