...
import { createGroupRoomMessage, createMessage, updateChatRoom, updateChatRoomUser, updateGroupRoom, updateGroupRoomUser } from "../../src/graphql/mutations";
...
const GroupInputBox = (props) => {
    ...
    const {groupRoomID, messageReplyTo, removeMessageReplyTo, CRUID, usersTokens, groupRoomName, inputBoxListUsers, myId, myName } = props;
    ...
    const onSendPress = async () => {
        ...
        try {
            ...
            await updateChatRoomLastMessage(newMessageData.data.createGroupRoomMessage.id);
            await updateCRLastMessage(newMessageData.data.createGroupRoomMessage.updatedAt);
            if (arrayOfPushTokens) {
    ...
    const onPressListUser = (item) => {
        setSelectedListUser(selectedListUser => [item, ...selectedListUser]);
